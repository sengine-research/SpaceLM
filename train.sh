...
--exp_name space_lm_model_qwen_llm_lr_5e-6_point_lr_2e-4_bs_16_full_finetune \
--stage_1_epochs 2 --stage_2_epochs 10 --batch_size 1 --gradient_accumulation_steps 16 --learning_rate 5e-6 --save_per_epoch 2