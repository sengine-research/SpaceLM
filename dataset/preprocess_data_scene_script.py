...
def process_one_scene(scene_path, output_dataset_path):
    ...
    coord, grid_coord, color, offset, inverse, feat = preprocess_point_cloud_and_normals(points, colors, normals, grid_size, shift_type="positive")
...
if __name__ == "__main__":
    ...
    output_root = os.path.join(args.dataset_dir, args.dataset_name)
